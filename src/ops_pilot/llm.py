...
def _ops_pilot_post_pilot_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "properties": {
            ...
            "pain_points": {"type": "array", "items": pain_point, "minItems": 1},
            "kpis": {"type": "array", "items": kpi, "minItems": 1},
            "risks": {"type": "array", "items": risk, "minItems": 1},
            "rollout_steps": {"type": "array", "items": rollout_step, "minItems": 1},
            "next_steps": {"type": "array", "items": text_field, "minItems": 1},
            "assumptions": {"type": "array", "items": text_field, "minItems": 1},
        },
        "required": [
